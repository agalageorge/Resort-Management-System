    ...
    <div class="main_content">
        ...
        <div class="admin_sales_contents">
            <div class="admin_sales_content_top">
                <nav><a href="front_desk_orders.php"><i class="fa fa-cart-plus"></i> Manage Orders </a></nav>
                <nav><a href="front_desk_report.php"><i class="fa fa-cart-plus"></i> Report</a></nav>
            </div>

            <div class="admin_sales_content_down">
                <h2>Manage Orders (Front Desk Only)</h2>
                ...
                <br>
                <a href="front_desk.php" class="btn btn-secondary" style="margin-left: 20px;">Back</a>
            </div>
        </div>
    </div>
</div>
