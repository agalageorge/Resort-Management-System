...
if ($start_date && $end_date) {
    ...
    // 🔥 MOST RECENT FIRST
    $sql .= " ORDER BY s.sales_date DESC, s.receipt_no DESC LIMIT ? OFFSET ?";
    $params[] = $limit;
    $params[] = $offset;
    $types   .= "ii";
    ...
    <div class="main_content">
        <div class="user_content_header">
            <h2 style="margin: 20px;">
                Report by Item - All Departments
            </h2>
        ...
        <div class="user_contents">
            ...
            <div class="user_content_top">
                <nav><a href="payment_type_search.php"><i class="fa fa-cart-plus"></i> Payment Method</a></nav>
                <nav><a href="item_search.php"><i class="fa fa-cart-plus"></i> Item Name</a></nav>
            </div>
            ...
            <div class="admin_sales_content_down" style="margin-left: 10px;">
                ...
                <form method="GET" class="report-form">
                    ...
                    <label>
                        Item:
                        <select name="item_id">
                            <option value="">All Items (All Departments)</option>
                    ...
                    <?php if (!empty($records)): ?>
                        <table>
                            ...
                            <tbody>
                                ...
                                <?php endforeach; ?>
                                <tr class="total">
                                    <td colspan="8"><strong>Total (this page)</strong></td>
