...
/* =========================
   FORCE ARK BAR DEPARTMENT
========================= */
$frontDeskSql = "SELECT department_id, name FROM departments WHERE name = 'Ark Bar' LIMIT 1";
$frontDeskResult = $conn->query($frontDeskSql);
if (!$frontDeskResult || $frontDeskResult->num_rows === 0) {
    die("Error: Ark Bar department not found.");
}
    ...
    <div class="main_content">
        ...
        <div class="user_contents">
            ...
            <div class="user_content_top">
                <nav><a href="ark_bar_payment_type_search.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Payment Method</a></nav>
                <nav><a href="ark_bar_item_search.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Item Name</a></nav>
            </div>
