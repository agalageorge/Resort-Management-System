    ...
    <div class="main_content">
        ...
        <div class="admin_sales_contents">
            <div class="admin_sales_content_top">
                <nav><a href="bush_bar_orders.php"><i class="fa fa-cart-plus"></i> Manage Orders </a></nav>
                <nav><a href="bush_bar_report.php"><i class="fa fa-cart-plus"></i> Report</a></nav>
            </div>

            <div class="admin_sales_content_down">
                <h2>Manage Orders (Bush Bar Only)</h2>
