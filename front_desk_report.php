...
// Assume this is Vip Bar restricted view (change if some users can see all)
$canViewAll = false; // ← change to true if admin / superadmin

/* ================================
   GET FRONT DESK DEPARTMENT ID
================================ */
$deptSql = "SELECT department_id, name FROM departments WHERE name = 'Front Desk' LIMIT 1";
$deptResult = $conn->query($deptSql);
if (!$deptResult) {
    die("Database error: " . $conn->error);
}
if ($deptResult->num_rows === 0) {
    die("Front Desk department not found in database.");
}
    ...
    <div class="main_content">
        ...
        <div class="user_contents">
            ...
            <div class="user_content_top">
                <nav><a href="front_desk_payment_type_search.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Payment Method</a></nav>
                <nav><a href="front_desk_item_search.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Item Name</a></nav>
            </div>
