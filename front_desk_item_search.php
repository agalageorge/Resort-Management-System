    ...
    <div class="main_content">
        ...
        <div class="user_contents">
            ...
            <div class="user_content_top">
                <nav><a href="front_desk_payment_type_search.php"><i class="fa fa-cart-plus"></i> Payment Method</a></nav>
                <nav><a href="front_desk_item_search.php"><i class="fa fa-cart-plus"></i> Item Name</a></nav>
            </div>
