...
/* =========================
   FORCE FRONT DESK DEPARTMENT
========================= */
$frontDeskSql = "SELECT department_id, name FROM departments WHERE name = 'Front Desk' LIMIT 1";
$frontDeskResult = $conn->query($frontDeskSql);

if (!$frontDeskResult || $frontDeskResult->num_rows === 0) {
    die("Error: Front Desk department not found.");
}
