...
/* =========================
   GET ARK BAR DEPARTMENT ID
========================= */
$deptSql = "SELECT department_id FROM departments WHERE name = 'Ark Bar' LIMIT 1";
$deptResult = $conn->query($deptSql);
$deptRow = $deptResult->fetch_assoc();

if (!$deptRow) {
    die("Ark Bar department not found.");
}
            ...
            <div class="admin_contents">
                <div class="admin_left_content">
                    <div class="admin_store_content_top">
                        <nav id="store_house"><a href="ark_bar_orders.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Manage Orders </a></nav>
                        <nav id="store_house"><a href="ark_bar_report.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Report</a></nav>
                    </div>
