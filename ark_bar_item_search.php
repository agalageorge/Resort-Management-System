    ...
    <div class="main_content">
        ...
        <div class="user_contents">
            ...
            <div class="user_content_top">
                <nav><a href="ark_bar_payment_type_search.php"><i class="fa fa-cart-plus"></i> Payment Method</a></nav>
                <nav><a href="ark_bar_item_search.php"><i class="fa fa-cart-plus"></i> Item Name</a></nav>
            </div>
