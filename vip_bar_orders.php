...
/* ================================
   TOTAL GROUPED ORDERS (FRONT DESK ONLY)
================================ */
$total_sql = "
    ...
    <div class="main_content">
        ...
        <div class="admin_sales_contents">
            <div class="admin_sales_content_top">
                <nav><a href="vip_bar_orders.php"><i class="fa fa-cart-plus"></i> Manage Orders </a></nav>
                <nav><a href="vip_bar_report.php"><i class="fa fa-cart-plus"></i> Report</a></nav>
            </div>

            <div class="admin_sales_content_down">
                <h2>Manage Orders (VIP Bar Only)</h2>
                ...
                <br>
                <a href="vip_bar.php" class="btn btn-secondary" style="margin-left: 20px;">Back</a>
            </div>
        </div>
    </div>
</div>
