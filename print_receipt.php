...
// Get basic receipt info from first item
$receipt = $items[0];
...
<head>
    ...
    <style>
        body { font-family: monospace; padding: 0; margin: 0; background: #fff; }
        .receipt { width: 300px; padding: 10px; margin: auto; }
        .center { text-align: center; }
        .line { border-top: 1px dashed #000; margin: 5px 0; }
        table { width: 100%; font-size: 13px; border-collapse: collapse; }
        th, td { padding: 3px 0; border-bottom: 1px dashed #ccc; }
        .bigtotal { font-size: 18px; font-weight: bold; }
...
<div class="receipt">
    ...
    <table>
        ...
        <tr><td>Staff:</td><td><?php echo $receipt['staff_first_name'] . " " . $receipt['staff_last_name']; ?></td></tr>
    </table>
